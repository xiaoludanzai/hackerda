...
public class GpaRanker {
    ...
    public RankResult rank(StudentUser studentUser, double gpa){
    ...
    public RankResult getRank(StudentUser studentUser){
        ZSetOperations<String, String> zSet = stringRedisTemplate.opsForZSet();
    ...
    private String getKey(StudentUser studentUser){
